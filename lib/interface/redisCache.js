...
// Node-Cache가 5.X에 Breaking change가 있다 (no more callback)
///////////////////////////////////////////////////////////////////////////////////////////////////
'use strict';
...
exports.ttl = function (cachekey, callback)
{
    ...
    {
        let result = myCache.getTtl(cachekey);
            callback(result);
    }
};
...
exports.get = function (cachekey, callback)
{
    ...
    else
    {
        ...
        {
            callback('myCache.get:not found',result);
        }
        else
        {
            callback(null,result);
...
exports.set = function (cachekey, value, ttl, callback)
{
    if (value)
    {
        ...
        {
            let result = myCache.set(cachekey, value, ttl);
            ...
            {
                callback('myCache.set write error');
            }
        }
